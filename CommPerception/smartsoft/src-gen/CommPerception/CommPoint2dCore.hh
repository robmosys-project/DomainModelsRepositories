...
//--------------------------------------------------------------------------
#ifndef COMMPERCEPTION_COMMPOINT2D_CORE_H_
#define COMMPERCEPTION_COMMPOINT2D_CORE_H_
...
protected:
	// data structure
	CommPerceptionIDL::CommPoint2d idl_CommPoint2d;
	
public:
	// give a publicly accessible type-name for the template parameter IDL
	typedef CommPerceptionIDL::CommPoint2d DATATYPE;
	...
	static inline std::string identifier(void) { return "CommPerception::CommPoint2d"; }
...
#endif /* COMMPERCEPTION_COMMPOINT2D_CORE_H_ */
