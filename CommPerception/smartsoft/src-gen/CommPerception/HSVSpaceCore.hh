...
//--------------------------------------------------------------------------
#ifndef COMMPERCEPTION_HSVSPACE_CORE_H_
#define COMMPERCEPTION_HSVSPACE_CORE_H_
...
protected:
	// data structure
	CommPerceptionIDL::HSVSpace idl_HSVSpace;
	
public:
	// give a publicly accessible type-name for the template parameter IDL
	typedef CommPerceptionIDL::HSVSpace DATATYPE;
	...
	static inline std::string identifier(void) { return "CommPerception::HSVSpace"; }
...
#endif /* COMMPERCEPTION_HSVSPACE_CORE_H_ */
