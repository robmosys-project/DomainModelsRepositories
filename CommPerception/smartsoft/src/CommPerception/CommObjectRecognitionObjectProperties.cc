...
CommObjectRecognitionObjectProperties::CommObjectRecognitionObjectProperties(const unsigned int &object_id, const std::string &object_type, const CommBasicObjects::CommPose3d &pose, const CommBasicObjects::CommPosition3d &dimension, const std::vector<CommObjectRecognitionObjects::CommObjectBelief> &beliefs, const CommObjectRecognitionObjects::CommTriMesh &mesh, const std::vector<CommObjectRecognitionObjects::CommObjectRelation> &relations, const std::vector<CommBasicObjects::CommPose3d> &objectSurfacePoses, const bool &is_valid, const double &fill_level)
